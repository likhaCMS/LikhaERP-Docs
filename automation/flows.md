...
Flows enable custom, event-driven data processing and task automation. Each flow is composed of one trigger, a series of operations, and a data chain that is passed between each step.
...
> Flows configured to track will store this information in the database, which may require occasionally deleting.
...
*Video documentation available in the admin panel.*