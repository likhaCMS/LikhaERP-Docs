...
An env agnostic serializer and deserializer with recursion ability and types beyond *JSON* from the *HTML* standard itself.
  ...
  * [Supported Types](https://developer.mozilla.org/en-US/docs/Web/Web_Workers_API/Structured_clone_algorithm#supported_types)
  ...
  * [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/structuredClone)
