...
Renders input as a [Node.js Readable stream](https://nodejs.org/stream.html#stream_class_stream_readable).
...
Render and pipe to an existing [Node.js Writable stream](https://nodejs.org/stream.html#stream_writable_streams) instance.
...
Renders input as a [Web ReadableStream](https://developer.mozilla.org/en-US/docs/Web/Streams_API).
...
Render and pipe to an existing [Web WritableStream](https://developer.mozilla.org/en-US/docs/Web/WritableStream) instance.
...
This is typically used in combination with [`TransformStream`](https://developer.mozilla.org/en-US/docs/Web/TransformStream):
