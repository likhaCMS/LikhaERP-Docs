...
[MessageChannel](https://developer.mozilla.org/en-US/docs/Web/MessageChannel) will automatically serialize the message and support circular references out-of-box.
