...
- 1756c90: Add support for new [inert](https://developer.mozilla.org/en-US/docs/Web/HTMLElement/inert#browser_compatibility) attribute ([#292](https://github.com/focus-trap/tabbable/issues/292))
