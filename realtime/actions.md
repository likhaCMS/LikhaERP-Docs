...
Learn to execute CRUD actions via WebSocket connections. This covers performing read, create, update, and delete operations on your collections.

**Note:** GraphQL Subscriptions do not support CRUD actions. This guide only applies to WebSocket connections.
...
You can also use delete items based on a provided `query` property. To delete all items, provide an empty query object.
